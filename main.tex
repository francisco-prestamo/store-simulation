...
\author{Francisco Préstamo Bernárdez}
\date{}
...
Se realizaron múltiples simulaciones variando el número de cajeros (1-10):
\begin{itemize}
    ...
    \item Con 5 o más cajeros, se evidencia en la gráfica que ya no varia el tiempo medio de cierre. 
\end{itemize}
